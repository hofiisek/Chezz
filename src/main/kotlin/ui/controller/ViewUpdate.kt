...
/**
 * Render object storing data to be rendered in the [BoardView].
...
sealed class RenderObject {
    ...
    data class Check(val board: Board) : RenderObject()

    object Checkmate : RenderObject()
    object Stalemate : RenderObject()
}